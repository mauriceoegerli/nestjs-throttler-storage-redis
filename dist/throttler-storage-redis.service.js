...
let ThrottlerStorageRedisService = class ThrottlerStorageRedisService {
    ...
    async getRecord(key) {
        var _a, _b;
        const ttls = (await this.redis.scan(0, 'MATCH', `${(_b = (_a = this.redis) === null || _a === void 0 ? void 0 : _a.options) === null || _b === void 0 ? void 0 : _b.keyPrefix}${key}:*`, 'COUNT', this.scanCount)).pop();
